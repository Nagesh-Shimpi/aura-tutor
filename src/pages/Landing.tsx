...
const Landing = () => {
  ...
  return (
    <main className="min-h-screen w-full bg-[hsl(222_47%_5%)] text-foreground overflow-x-hidden relative">
      {/* Ambient gradient blobs */}
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-32 -left-32 w-[520px] h-[520px] rounded-full bg-primary/20 blur-3xl" />
        <div className="absolute top-1/3 -right-40 w-[600px] h-[600px] rounded-full bg-accent/15 blur-3xl" />
        <div className="absolute bottom-0 left-1/3 w-[400px] h-[400px] rounded-full bg-primary-glow/15 blur-3xl" />
      </div>
      ...
      {/* Hero */}
      <section className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 pt-16 md:pt-28 pb-24 grid lg:grid-cols-2 gap-12 items-center">
        {/* Left: copy */}
        <div>
          <h1 className="font-display font-bold tracking-tight leading-[1.02] text-5xl md:text-6xl lg:text-7xl">
            Learn smarter, <br />
            master every{" "}
          ...
          <p className="mt-6 text-base md:text-lg text-muted-foreground max-w-xl leading-relaxed">
            Stop guessing what to study next. Lumina turns every question into a personalized lesson —
          ...
          <div className="mt-10 flex items-center gap-4">
            ...
            <div className="glass rounded-full px-4 py-2.5 text-xs text-muted-foreground flex items-center gap-2">
        ...
        <div className="relative h-[560px] hidden lg:block">
          {/* Quiz card */}
          <div className="absolute top-0 right-8 w-[300px] glass-card rounded-2xl p-4 shadow-[0_20px_50px_-20px_hsl(258_90%_66%/0.5)] animate-float">
            <div className="flex items-center gap-2 text-xs text-muted-foreground mb-3">
              <Trophy className="w-3.5 h-3.5 text-primary-glow" />
              <span className="tracking-widest font-semibold">QUIZ</span>
            </div>
            <p className="text-sm font-semibold mb-3">What does <code className="text-accent bg-secondary/60 px-1.5 py-0.5 rounded text-xs">map()</code> return?</p>
          ...
          {/* Chatbot card */}
          <div className="absolute top-[230px] -left-4 w-[320px] glass-card rounded-2xl p-4 shadow-[0_20px_50px_-20px_hsl(199_95%_60%/0.4)] animate-float" style={{ animationDelay: "1.2s" }}>
            <div className="flex items-center gap-2 text-xs text-muted-foreground mb-3">
          ...
          {/* Profile card */}
          <div className="absolute bottom-4 right-0 w-[280px] bg-gradient-primary rounded-2xl p-4 shadow-[0_25px_60px_-20px_hsl(258_90%_66%/0.7)] animate-float" style={{ animationDelay: "0.6s" }}>
